...
class _MyHomePageState extends State<MyHomePage> {
 ...
 List<Widget> _buildLandscapeContent(MediaQueryData mediaQuery, AppBar appBar, Widget tkListWidge) {
    return [Row(
  ...
  List<Widget> _buildPortraitContent(MediaQueryData mediaQuery, AppBar appBar, Widget tkListWidge) {
    return [Container(
   ...
   final isLandscape = mediaQuery.orientation == Orientation.landscape;
    ...
    final pageBody = SafeArea(child: SingleChildScrollView(
      child: Column(
        ...
        children: [
          if(isLandscape) ... _buildLandscapeContent(mediaQuery, appBar, tkListWidge),
          if(!isLandscape)... _buildPortraitContent(mediaQuery, appBar, tkListWidge),
        ],
      ),
    ), );
